...
def _m(title: str, link: str = "") -> LensMatch:
    return LensMatch(rank=1, title=title, link=link,
                     source="", platform=_platform_of(link), reason="")
...
TORTURE_CASES: list[tuple[str, str, str]] = [
    ...
    ("Virat Kohli (@viratkohli123) • Instagram photos and videos",
     "https://www.instagram.com/viratkohli123/", "virat kohli"),
    ...
    ("Satya Nadella | Facebook",
     "https://www.facebook.com/satyanadella/", "satya nadella"),
    ("Narendra Modi - Home | Facebook",
     "https://www.facebook.com/narendramodi/", "narendra modi"),
    ("Mark Zuckerberg - Home | Facebook",
     "https://www.facebook.com/markzuckerberg/", "mark zuckerberg"),
    ("Cristiano Ronaldo - Home | Facebook",
     "https://www.facebook.com/Cristiano/", "cristiano ronaldo"),

    # ---------------- YouTube channels / Topics ------------------------------
    ("Virat Kohli - Topic - YouTube",
     "https://www.youtube.com/channel/UC", "virat kohli"),
    ("Sundar Pichai - YouTube",
     "https://www.youtube.com/@sundarpichai", "sundar pichai"),
    ("Marques Brownlee - YouTube",
     "https://www.youtube.com/@MKBHD", "marques brownlee"),
    ("BBC News - YouTube",
     "https://www.youtube.com/@BBCNews", ""),  # organization, not a person
    ("NASA - YouTube",
     "https://www.youtube.com/@NASA", ""),  # org
    ("@cristiano • YouTube",
     "https://www.youtube.com/@cristiano", ""),  # handle only
    ...
    ("Tim Cook - Apple CEO | LinkedIn",
     "https://www.linkedin.com/in/timcook/", "tim cook"),

    # ---------------- TikTok -------------------------------------------------
    ("Lionel Messi (@leomessi) | TikTok",
     "https://www.tiktok.com/@leomessi", "lionel messi"),
    ("Charli D'Amelio (@charlidamelio) | TikTok",
     "https://www.tiktok.com/@charlidamelio", "charli d'amelio"),  # contains an apostrophe
    ...
    ("Dr. Anthony Fauci - Wikipedia", "https://en.wikipedia.org/wiki/Anthony_Fauci", "anthony fauci"),
    ("Prof. Stephen Hawking - Wikipedia", "https://en.wikipedia.org/wiki/Stephen_Hawking", "stephen hawking"),
    ...
    ("Mary Jane Watson - Wikipedia", "https://en.wikipedia.org/wiki/Mary_Jane_Watson", "mary jane watson"),
